...
export const CONTRACT_INSTANTIATION_FAILED = (contract: 'marketplace' | 'swivel' | 'vault tracker', address: string): string =>
    `Failed to instantiate deployed ${ contract } contract at ${ address }.`;

export const MISSING_CONTRACT_ADDRESS = (contract: 'marketplace' | 'swivel' | 'vault tracker'): string =>
