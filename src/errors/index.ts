...
export const CONTRACT_INSTANTIATION_FAILED = (contract: 'market-place' | 'swivel' | 'vault-tracker' | 'utoken', address: string): string =>
    `Failed to instantiate deployed ${ contract } contract at ${ address }.`;

export const MISSING_CONTRACT_ADDRESS = (contract: 'market-place' | 'swivel' | 'vault-tracker' | 'utoken'): string =>
