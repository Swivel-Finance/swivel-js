...
import { cloneWithWriteAccess } from '../src/helpers';
import { Contract, Order, TxResponse } from '../src/interfaces';
...
describe('Swivel cancel method', () => {
    ...
    // allow stubbing contract properties
        swivel.contract = cloneWithWriteAccess(swivel.contract) as Contract;
