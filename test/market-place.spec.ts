...
describe('MarketPlace', () => {
    ...
    describe('redeemZcToken', () => {
        ...
        it('throws if deployed contract is not wrapped', async () => {
            ...
            await assertThrows(marketPlace, 'redeemZcToken');
        });
        ...
        it('converts arguments and passes them to vendor specific contract instance', async () => {
            ...
            const maturity = 1640987320;
            const amount = '1000';
            const response = await marketPlace.redeemZcToken(underlying, maturity, amount);
    ...
    describe('redeemVaultInterest', () => {
        ...
        it('throws if deployed contract is not wrapped', async () => {
            ...
            await assertThrows(marketPlace, 'redeemVaultInterest');
        });
        ...
        it('converts arguments and passes them to vendor specific contract instance', async () => {
            ...
            const underlying = '0xunderlying';
            const maturity = 1640987320;
            const response = await marketPlace.redeemVaultInterest(underlying, maturity);
